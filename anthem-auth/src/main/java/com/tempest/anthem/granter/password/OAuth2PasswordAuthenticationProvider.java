...
public class OAuth2PasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        OAuth2RefreshToken refreshToken = new OAuth2RefreshToken(generatedRefreshToken.getTokenValue(), generatedRefreshToken.getIssuedAt(),
...
//        OAuth2RefreshToken refreshToken = new OAuth2RefreshToken(accessToken.getTokenValue(),accessToken.getIssuedAt(), accessToken.getExpiresAt());
//        authorizationBuilder.refreshToken(refreshToken);
