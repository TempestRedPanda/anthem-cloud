 ...
 */
package com.tempest.anthem.redis.service;
...
final class ModelMapper {
    ...
    static OAuth2AuthorizationGrantAuthorization convertOAuth2AuthorizationGrantAuthorization(
        ...
        if (AuthorizationGrantType.AUTHORIZATION_CODE.equals(authorization.getAuthorizationGrantType())) {
            ...
            return convertPasswordAuthorizationGrantAuthorization(authorization);
        }
        return null;
    }
     ...
     */
    private static OAuth2AuthorizationGrantAuthorization convertPasswordAuthorizationGrantAuthorization(
            OAuth2Authorization authorization) {
    ...
    static void mapOAuth2AuthorizationGrantAuthorization(
        ...
        if (authorizationGrantAuthorization instanceof OidcAuthorizationCodeGrantAuthorization authorizationGrant) {
            ...
            mapPasswordAuthorizationCodeGrantAuthorization(authorizationGrant, builder);
    ...
    static void mapPasswordAuthorizationCodeGrantAuthorization(
            OAuth2PasswordGrantAuthorization authorizationGrantAuthorization,
            OAuth2Authorization.Builder builder) {
        ...
        builder.principalName(authorizationGrantAuthorization.getPrincipalName())
                ...
                .attribute(Principal.class.getName(), authorizationGrantAuthorization.getPrincipal());
    ...
    static void mapAccessToken(OAuth2AuthorizationGrantAuthorization.AccessToken accessToken,
        ...
        String name = OAuth2TokenFormat.class.getName();
        String value =  accessToken.getTokenFormat().getValue();
